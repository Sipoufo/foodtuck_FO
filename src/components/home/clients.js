...
const Clients = () => {
    return(
        <div className="relative flex w-full h-80 justify-center text-white bg-black py-10 text-lg font-semibold">
            ...
            <div className="absolute flex flex-row max-w-screen-xl w-full h-full justify-center items-center">
                <div className="flex flex-row w-full max-w-screen-xl gap-4 justify-between items-center">
