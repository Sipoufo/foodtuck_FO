    ...
    return(
        <div className="flex w-full justify-center text-white bg-black py-10">
            <div className="flex flex-row max-w-screen-xl w-full justify-center items-center px-10">
                <div className="flex flex-col gap-4 w-fit text-xs">
                    <h1 className="font-great-vibes text-primary-color text-2xl md:text-3xl">About us</h1>
                ...
                <div className="hidden md:flex flex-col w-5/12 gap-3 h-96">
